export function SpanishFlag(props: any) {
  return (
    <svg
      ...
      <g stroke="#000" strokeWidth={0.39}>
        <g strokeWidth={0.26}>
          ...
          <g fill="#c8b100">
            ...
            <ellipse cx={175.68} cy={213.04} rx={0.93} ry={0.87} stroke="none" />
            <path
              strokeWidth={0.3}
          ...
          <g id="prefix__b" fill="none">
            ...
            />
            <path strokeWidth={0.01} d="M176.8 226.08v-1.16m-.58 1.2l.01-1.23m-.43 1.25v-1.26" />
            <path strokeWidth={0.02} d="M175.44 226.15v-1.27" />
            <path strokeWidth={0.03} d="M175.09 226.15v-1.27" />
            <path strokeWidth={0.04} d="M174.77 226.15v-1.27M174.44 226.15v-1.27" />
            <path strokeWidth={0.05} d="M174.16 226.15v-1.27" />
            <path strokeWidth={0.06} d="M173.61 226.08l-.01-1.15m.27 1.17v-1.21" />
            <path strokeWidth={0.07} d="M173.1 226.03v-1.06m.26 1.09l-.01-1.13" />
            <path strokeWidth={0.08} d="M172.42 225.97v-.93m.23.94V225m.23 1.02V225" />
            ...
            <path strokeWidth={0.12} d="M171.24 225.82l-.01-.62m.26.66v-.7M170.99 225.77v-.55" />
        ...
        <g strokeWidth={0.26}>
          ...
          <g fill="#c8b100">
            ...
            <ellipse cx={324.84} cy={213.95} rx={0.93} ry={0.88} stroke="none" />
            <path
              strokeWidth={0.3}
          ...
          <use xlinkHref="#prefix__a" x={149.17} />
          <use xlinkHref="#prefix__b" x={149.17} />
        </g>
        <use xlinkHref="#prefix__c" x={149.17} />
        <use xlinkHref="#prefix__d" transform="matrix(-1 0 0 1 500.57 0)" />
        ...
        <g>
          ...
          <g fill="#c8b100">
            ...
            <ellipse fill="#005bbf" strokeWidth={0.26} cx={250.05} cy={167.3} rx={4.43} ry={4.2} />
            <path
              strokeWidth={0.26}
          ...
          <g fill="none">
            ...
            <path strokeWidth={0.33} d="M241.48 224.28l-.04-5.97m1.39 6.05v-6.25" />
            <path strokeWidth={0.37} d="M238.86 224.01v-5.5m1.33 5.66l-.04-5.86" />
            <path strokeWidth={0.42} d="M235.35 223.7v-4.84m1.15 4.92v-5.08m1.19 5.24v-5.28" />
            ...
            <path strokeWidth={0.6} d="M229.22 222.95l-.04-3.22m1.33 3.38v-3.62" />
        ...
        <g strokeWidth={0.52}>
          ...
          <g>
            ...
            />
            <use xlinkHref="#prefix__e" transform="matrix(-1 0 0 1 550.43 0)" />
            <path
              fill="#058e6e"
          ...
          <g fill="#c8b100" strokeWidth={0.46}>
            <path fill="#ad1519" strokeWidth={0.52} d="M200.12 281.25h50.18v-55.72h-50.18v55.72z" />
          ...
          <g>
            ...
            <g fill="#db4446" strokeWidth={0.39}>
          ...
          <g strokeWidth={0.61}>
            ...
            <g id="prefix__f" fill="#c8b100" strokeWidth={0.34}>
              <path
                strokeLinejoin="round"
            ...
            <use xlinkHref="#prefix__f" x={10.63} />
            <use xlinkHref="#prefix__f" x={5.31} y={9.14} />
          </g>
        </g>
      </g>
    </svg>
